...
test('combine()', function (t) {
    t.test('combines a single item', function (st) {
        st.deepEqual(utils.combine('a', 'b', 10, false), ['a', 'b'], 'combines two values into an array');
        st.end();
    });

    t.test('combines an array and a value', function (st) {
        st.deepEqual(utils.combine(['a'], 'b', 10, false), ['a', 'b'], 'combines array and value');
        st.end();
    });
